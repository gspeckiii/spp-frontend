...
function Main() {
  ...
  useEffect(() => {
    if (state.loggedIn) {
      ...
      console.log(
        "localStorage updated, SPPuser_id:",
        state.user.user_id,
        "SPPusername:",
        state.user.username
      );
  ...
  useEffect(() => {
    ...
    if (state.loggedIn) {
      console.log(
        "Starting token refresh with interval:",
      ...
      refreshIntervalId = setInterval(async () => {
        try {
          ...
          console.log(
            "Token refreshed, new interval:",
            response.data.refreshInterval || state.user.refresh_interval
          );
          ...
          <BrowserRouter>
            ...
            <main className="main-content-area">
              <Routes>
                ...
                />
                <Route
                  path="/admin-product-put/:id"
                  element={<AdminProductPut />}
                />
                <Route
