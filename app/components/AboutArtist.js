    ...
    <div className="container container--two-column">
      ...
      <div className="container__column-right container__column-right--v-center">
        <p className="container__text-block">
          ...
          those who came before us while leaving behind a meaningful legacy. My
          work explores truths that exist beyond the simple frameworks of good
          and evil, using the creative act as a tool for radical
