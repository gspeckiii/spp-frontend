    ...
    <Page title="About Us">
      <div className="wrapper wrapper--dark wrapper--center">
        ...
        <div class="section">
          ...
          <p>Montana State University, Bozeman, MT, May 2009</p>
          <p>Cumulative GPA: 3.12</p>
          <ul>
        ...
        <div class="section">
          ...
          <p>
            Results-driven industrial engineer with over 13 years of experience
            in aerospace manufacturing, specializing in process optimization,
            discrete event simulation, and data analytics. Proficient in SQL,
            Python, and modeling tools like Simio and ProModel, with a proven
            track record of delivering $1.5M in cost savings and improving
            operational efficiency by up to 25%. Adept at leading
            cross-functional teams to solve complex problems in fast-paced
            environments, aligning with America's mission to advance technology
        ...
        <div class="section">
          ...
          <p>Mar 2025 - Current</p>
          <ul>
            <li>
              Venue to establish a portfolio of industrial engineering services
              and love of humanity. The enduring strength of the human spirit is
              an inspiration to me and this application is a medium in which I
              can express my principals and perceptions.
            </li>
            <li>
          ...
          <p>Aug 2022 - Mar 2025</p>
          <ul>
            <li>
              Conducted discrete event simulations to optimize 737 assembly line
              processes, improving resource utilization by 25%.
            </li>
            <li>
            ...
            <li>
              Developed a web-based application using JavaScript and HTML/CSS to
              track benchmarking data, increasing process accuracy by 30%.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              Created simulations and applications for work studies using Python
              and Simio, reducing labor costs by 15%.
            </li>
            <li>
          ...
          <p>Sep 2016 - Jan 2019</p>
          <ul>
            <li>
              Built SQL Server applications and Tableau dashboards to track 500+
              production plans, boosting team productivity by 35%.
            </li>
            <li>
          ...
          <h3>
            Industrial Engineer, Automation Support, Boeing Company, Everett, WA
          </h3>
          <p>May 2014 - Sep 2016</p>
          <ul>
            <li>
            ...
            <li>
              Automated job sequencing with SQL Server, reducing manual workload
              by 30%.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              Presented constraint-based scheduling solutions at the 2013 ISE
              Conference, showcasing 15% efficiency gains.
            </li>
          </ul>
        </div>
        ...
        <div class="section">
          ...
          <ul>
            ...
            <li>
              <strong>Process Optimization:</strong> Discrete event simulation,
              constraint-based scheduling, data visualization, capacity planning
            </li>
            <li>
              <strong>Leadership:</strong> Cross-functional team collaboration,
        ...
        <div class="section">
          ...
          <ul>
            <li>Fundamentals of Engineering (FE) Certification, April 2009</li>
            <li>
              Presented at ISE Conference (2013): Constraint-Based Scheduling in
